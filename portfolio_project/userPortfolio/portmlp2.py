        ...
        for period in range(period_start, num_periods):
            ...
            for eachFeature in self.period_features:
                ...
                for each in train_data:
                    all_train.append(each)
                for each in train_labels:
                    all_train_labels.append(each)
                for each in test_data:
                    all_test.append(each)
                for each in test_labels:
                    all_test_labels.append(each)

            period_train_test_data.append((all_train, all_train_labels, all_test, all_test_labels, 3, 500, eachFeature['stockName']))
            self.period_train_test_data = period_train_test_data
